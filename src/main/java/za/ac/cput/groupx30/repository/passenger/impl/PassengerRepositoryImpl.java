package za.ac.cput.groupx30.repository.passenger.impl;
...
public class PassengerRepositoryImpl implements PassengerRepository {
    private static za.ac.cput.groupx30.repository.passenger.impl.PassengerRepositoryImpl repository = null;
    ...
    public static za.ac.cput.groupx30.repository.passenger.impl.PassengerRepositoryImpl getRepository(){
        if (repository == null) {
            repository = new za.ac.cput.groupx30.repository.passenger.impl.PassengerRepositoryImpl();
        }
        return repository;
    }
